...
PetscErrorCode mymatinvert(PetscInt *n, PetscScalar *mat, PetscInt *piv,
  ...
  // PetscStackCallBLAS("LAPACKgetri",LAPACKgetri_(&dof,&matValuesPerBlock[p][0],
  // &dof, &piv[0],&fwork[0],&dof,&info)); dgetrf(n,n,mat,n,piv,info);
  ...
  PetscStackCallBLAS("LAPACKgetri",
                     LAPACKgetri_(n, mat, n, piv, work, n, info));
  return 0;
}
